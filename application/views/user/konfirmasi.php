...
<!-- Sidebar end=============================================== -->
		...
		<br>
		<form>
	 Nama &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <input class="search search-hover" align="left" type="text" placeholder="Nama" width="500px"><br><br>
	 Alamat &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <input class="search search-hover" align="left" type="text" placeholder="Alamat" width="500px"><br><br>
	 Provinsi &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <input class="search search-hover" align="left" type="text" placeholder="Provinsi" width="500px"><br><br>
	 Kota &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp; <input class="search search-hover" align="left" type="text" placeholder="Kota" width="500px"><br><br>
	 Kecamatan =;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; <input class="search search-hover" align="left" type="text" placeholder="Kecamatan" width="500px"><br><br>
	 Nomor Telepon  :;&nbsp; 
	 <input class="search search-hover" align="left" type="text" placeholder="Nomor Telepon" width="500px"><br><br>
	 Email &nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp; 
	 <input class="search search-hover" align="left" type="text" placeholder="Email" width="500px"><br><br>
	 </form>
	 <div class="clearfix"></div>
                        <a class="order" href="<?php echo base_url(); ?>index.php/user/pesanansukses">Confirm</a>
                    </div>
	<br>
	<br>
	<br>
