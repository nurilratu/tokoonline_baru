...
<div class="check">
                <div class="container">	 
                    <div class="col-md-3 cart-total">
                        ...
                        <div class="clearfix"></div>
                        <a class="order" href="<?php echo base_url();?>index.php/user/konfirmasi">Confirm</a>
                    </div>
                ...
                <div class="close1"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></div>
                            <div class="cart-sec simpleCart_shelfItem">
                                    <div class="cart-item cyc">
                                        <img src="<?php echo base_url();?>assets/img/web/3.jpg" class="img-responsive" alt=""/>
                                    </div>
                ...
                <div class="close2"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></div>
                                <div class="cart-sec simpleCart_shelfItem">
                                    <div class="cart-item cyc">
                                         <img src="<?php echo base_url();?>assets/img/web/2.jpg" class="img-responsive" alt=""/>
                                    </div>
                                    <div class="cart-item-info">
                                        <ul class="qty">
                                            <li><p>Size : 8 US</p></li>
