...
<div class="header-top">
                    ...
                    <div class="login-bars">
                        ...
                        <div class="cart box_1">
                            <a href="<?php echo base_url(); ?>index.php/user/checkout">
                            <h3>
                                <div class="total">
<span class="simpleCart_total"></span></div>
                            </h3>
                            </a>
                            <button type="button" class="btn btn-default btn-lg button2 button2-hover"><a href="<?php echo base_url(); ?>index.php/user/checkout">0 cart</a>
							&nbsp;&nbsp;&nbsp;
